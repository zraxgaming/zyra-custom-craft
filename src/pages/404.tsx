...
const NotFound: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-950 dark:to-pink-950">
      <SEOHead 
        title="404 Not Found - Zyra Custom Craft"
        description="Sorry, the page you are looking for does not exist. Return to Zyra Custom Craft homepage."
        url="https://shopzyra.vercel.app/404"
        keywords="404, not found, error, zyra, custom craft"
      />
