...
const MaintenanceBanner = () => {
  ...
  return (
    <Alert className="rounded-none border-x-0 border-t-0 bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-950/20 dark:to-orange-950/20 border-yellow-200 dark:border-yellow-800 py-2">
